  ...
  <!--block b-slider end-->
	 ...
	 <a href="https://plus.google.com/u/1/105880503717175881767" rel="author" style="display: none;">damage-help.ru</a>
  <!-- Metrics -->
...
<!-- BEGIN JIVOSITE CODE {literal} -->
<!--<script type='text/javascript'>
(function(){ var widget_id = '5FZIFTY6g0';var d=document;var w=window;function l(){
...
<!-- {/literal} END JIVOSITE CODE -->
  ...
  <!--<script src="<?php /*echo get_template_directory_uri(); */?>/js/script.js"></script>-->
	...
	<script>
	    var _emv = _emv || [];
	    _emv['campaign'] = '289811f8a30ebd1cc41022ff';
